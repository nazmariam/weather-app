    ...
    render(){
                ...
                <div class="navigate-wrapper">
                    <ul class="forecast-list">
                        ...
                        <li class="forecast-item forecast-day-3">
                            <img src="images/sun-cloudy.svg" alt="">
		...
		<path d="M287,362h-62c-24.813,0-45,20.187-45,45s20.187,45,45,45h62c24.813,0,45-20.187,45-45S311.813,362,287,362z M287,422h-62
			c-8.271,0-15-6.729-15-15s6.729-15,15-15h62c8.271,0,15,6.729,15,15S295.271,422,287,422z"/>
                            ...
                            <tr>
                                <td class="temperature-data">1 <span class="unit">&#176;C</span></td>
                                <td class="humidity-data">58%</td>
                                <td class="wind-data">14 km/h</td>
                                <td class="pressure-data">102 atm</td>
                            </tr>
                        </table>
                    </div>
                    <div class="wheel-img">
                        <img src="images/handler.png" alt="">
                    </div>
                </div>
